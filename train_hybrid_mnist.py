...
def main():
    ...
    for epoch in range(config.epochs):
        ...
        with open('/content/drive/MyDrive/vit_project/logs/hybrid_mnist_metrics.txt', 'a') as f:
        ...
        if test_acc > best_acc:
            best_acc = test_acc
            torch.save(model.state_dict(), 'experiments/hybrid_mnist_best.pth')
            
        torch.save(
        model.state_dict(),
        f'/content/drive/MyDrive/vit_project/experiments/hybrid_mnist_epoch_{epoch+1}.pth'
        )
